...
Each timestep of EClusUCB involves both (individual) arm elimination as well as cluster elimination. This is the first algorithm in bandit literature which uses two simultaneous arm elimination conditions per timestep and show both theoretically and empirically that such an approach is indeed helpful.
