...
\begin{table}
\caption{Comparison of different algorithms against EClusUCB. The \checkmark indicates EClusUCB outperforms baseline. E1, E2 and E3 correspond to Experiment 1,2 and 3 in Section \ref{sec:expts}}
\label{tab:comp-bds}.
\begin{center}
