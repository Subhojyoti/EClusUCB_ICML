...
\begin{figure}[!h]
    ...
    &
    \subfigure[0.32\textwidth][Expt-$4$: Cumulative regret for ClusUCB for various clusters]
    {
    		\pgfplotsset{
		tick label style={font=\Huge},
		label style={font=\Huge},
